...
var ExampleList = React.createClass({
    renderItem: function(item) {
        return (
            <li key={item.id} className="list-group-item" style={{height: this.props.itemHeight}}>
    ...
    render: function() {
        return (
            <VirtualList tagName="ul" className="media-list list-group" container={this.props.container} items={this.props.items} renderItem={this.renderItem} itemHeight={this.props.itemHeight} />
        );
    }
});
