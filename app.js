...
},{"./utils/virtual-renderer":3,"react":176}],3:[function(require,module,exports){
...
var ConfigurableExample = React.createClass({displayName: "ConfigurableExample",
    ...
    renderItem: function(item) {
        return (
            React.createElement(this.state.itemTagName, {key: item.id, className: this.state.itemClassName, style: {height: this.state.itemHeight}}, 
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("div", {role: "form", className: "form-horizontal"}, 
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("label", {className: "col-xs-6 col-sm-2", htmlFor: "listTagName"}, "List tagName"), 
                        React.createElement("div", {className: "col-xs-6 col-sm-4"}, 
                            React.createElement("input", {onChange: this.update, className: "form-control", type: "text", value: this.state.tagName, id: "listTagName", ref: "listTagName"})
                        ), 
                        React.createElement("label", {className: "col-xs-6 col-sm-2", htmlFor: "listClassName"}, "List className"), 
                        React.createElement("div", {className: "col-xs-6 col-sm-4"}, 
                            React.createElement("input", {onChange: this.update, className: "form-control", type: "text", value: this.state.className, id: "listClassName", ref: "listClassName"})
                        )
                    ), 
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("label", {className: "col-xs-6 col-sm-2", htmlFor: "itemTagName"}, "Item tagName"), 
                        React.createElement("div", {className: "col-xs-6 col-sm-4"}, 
                            React.createElement("input", {onChange: this.update, className: "form-control", type: "text", value: this.state.itemTagName, id: "itemTagName", ref: "itemTagName"})
                        ), 
                        React.createElement("label", {className: "col-xs-6 col-sm-2", htmlFor: "itemClassName"}, "Item className"), 
                        React.createElement("div", {className: "col-xs-6 col-sm-4"}, 
                            React.createElement("input", {onChange: this.update, className: "form-control", type: "text", value: this.state.itemClassName, id: "itemClassName", ref: "itemClassName"})
                        )
                    ), 
                    React.createElement("div", {className: "form-group"}, 
                        ...
                        React.createElement("label", {className: "col-xs-6 col-sm-2", htmlFor: "containerHeight"}, "Container Height"), 
                        React.createElement("div", {className: "col-xs-6 col-sm-4"}, 
                            React.createElement("input", {onChange: this.update, className: "form-control", type: "number", min: "0", max: "10000", value: this.state.containerHeight, id: "containerHeight", ref: "containerHeight"})
                        )
                    ), 
                    React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-xs-12", id: "container", ref: "container", style: this.state.contained ? { overflow: 'scroll', height: this.state.containerHeight } : {}}, 
                        React.createElement(VirtualList, {items: this.state.items, renderItem: this.renderItem, className: this.state.className, container: this.state.contained ? this.state.container : window, itemHeight: this.state.itemHeight, tagName: this.state.tagName})
                    )
                )
            )
        );
...
},{"./dist/VirtualList.js":2,"react/addons":4}]},{},[177]);
